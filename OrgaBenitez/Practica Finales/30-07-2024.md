...
* Diferencia: en superabacus no existe el registro de proxima instruccion, sino que se usa el registro R0 y se suma usando la UAL
...
* Muchas instrucciones para trabaja con memoria: `ADD EAX, [EBX]`
